      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
        <div className="flex items-center gap-2 rounded border border-[#1E6B3A]/20 bg-[#1E6B3A]/5 p-4 text-[#1E6B3A]">
          ...
          <span className="font-semibold">
            {mode === "modal" ? "عرض وصل المعاملة" : "تم تسجيل المعاملة بنجاح"}
          </span>
        </div>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <button
            type="button"
            onClick={handlePrint}
            className="flex items-center gap-2 rounded-lg border border-[#B08D57] bg-[#B08D57] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#9C7B49]"
          >
            <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg border border-[#25D366] bg-[#25D366] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#20bd5a]"
          >
          ...
          {mode === "modal" && onClose && (
            <button
              type="button"
              onClick={onClose}
              className="flex items-center gap-2 rounded-lg border border-gray-200 px-4 py-2.5 text-sm font-medium text-[#1B1B1B] hover:bg-gray-50"
            >
              إغلاق
            </button>
          )}

        ...
        <div className="flex h-16 items-center justify-between gap-2 border-b border-[#d4cfc8] px-3">
          {!sidebarCollapsed ? (
            <Link href="/supervisor" className="flex min-w-0 flex-1 items-center gap-2">
              ...
              <span className="font-heading truncate text-[15px] font-bold text-[#1B1B1B]">الإشراف والمراقبة</span>
            </Link>
          ) : (
        ...
        >
          ...
          <div className="flex flex-1 flex-row flex-wrap items-center justify-between gap-2 sm:gap-4">
            ...
            <div className="flex flex-shrink-0 items-center gap-3">
              ...
              <button type="button" onClick={() => void safeSignOut()} className="hidden items-center gap-2 rounded-lg border border-[#d4cfc8] bg-white px-3 py-2 text-sm font-medium text-[#1B1B1B] hover:bg-[#f6f3ed] lg:flex">
